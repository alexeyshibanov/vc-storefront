...
namespace VirtoCommerce.Storefront.Controllers.Api
{
    ...
    public class ApiCommonController : StorefrontControllerBase
    {
        ...
        public ApiCommonController(IWorkContextAccessor workContextAccessor, IStorefrontUrlBuilder urlBuilder,
            IStoreModule storeApi, PlatformModuleClient platformModuleClient, IOptions<FormFileStorageOptions> formFileStorageOptions)
