...
namespace VirtoCommerce.Storefront.Domain
{
    ...
    {
        private static readonly ConcurrentDictionary<string, CancellationTokenSource> _customerReviewRegionTokenLookup =
            new ConcurrentDictionary<string, CancellationTokenSource>();

        public static IChangeToken CreateCustomerReviewChangeToken(string productId)
        {
            if (productId == null)
            {
